...
export const Hero:React.FC = () => {
    return (
        <div id='test' className='h-[100%] text-black background-waves text-center'>
            <div className='pt-[10%] text-6xl lg:text-black' id='home'>
                <span>
            ...
            <div className='text-black mx-[10%] lg:mx-[20%] mt-[4%] rounded-xl pb-8 pt-0.5'>
                <div className='bg-white md:grid shadow-lg rounded-xl shadow-neutral-400 md:grid-cols-3 lg:grid-cols-3 pb-4'>
